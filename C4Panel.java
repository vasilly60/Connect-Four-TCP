...
/**
 * Class C4Panel provides a widget for displaying a Connect Four Board
 * in a UI.
 * 
...
public class C4Panel extends JPanel {
	...
	private static final BasicStroke WIN_STROKE = new BasicStroke(D / 4,
	 ...
	 * 
	 * @param board
	 *            Connect Four board object to be queried when
	...
	public C4Panel(C4BoardIntf board) {
		...
		Dimension dim = new Dimension(W * C4BoardIntf.COLS, W
				* C4BoardIntf.ROWS);
		setMinimumSize(dim);
	...
	/**
	 * Determine the column on this Connect Four panel that was
	 * clicked.
	 * 
	 * @param e
	 *            Mouse event.
